...
public class BookController {
    ...
    public ResponseEntity<?> updateBook(@PathVariable Long bookId, @RequestBody BookDto bookDto) {
        try {
            BookDto updatedBook = bookServiceImplementation.updateBook(bookId, bookDto);
    ...
    public ResponseEntity<?> bookDetailsByBookId(@PathVariable Long bookId) {
        try {
            BookDto book = bookServiceImplementation.getBookByBookId(bookId);
    ...
    public ResponseEntity<?> retriveReservedBooks(@PathVariable Long userId) {
        try {
            List<BookEntity> allBookByUser = reserveServiceImplementation.getAllReservedBookByUser(userId);
            return new ResponseEntity<>(allBookByUser, HttpStatus.OK);
        } catch (UnauthorizedException e) {
            return new ResponseEntity<>(e.getMessage(), HttpStatus.UNAUTHORIZED);
        } catch (BookWasNotBorrowedException e) {
